...
export function SignInForm({ canRegister }: { canRegister: boolean }) {
    ...
    <div className="bg-zinc-900/50 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl">
      ...
      <form action={action} className="space-y-5">
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="w-full h-12 bg-white text-black hover:bg-zinc-200 rounded-xl font-bold text-sm transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
        >
